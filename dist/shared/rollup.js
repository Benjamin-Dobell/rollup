...
const relativeUrlMechanisms = {
    ...
    umd: relativePath => {
        ...
        return `(typeof document === 'undefined' ? ${getResolveUrl(`'file:' + __dirname + '/${relativePath}'`, `(require('u' + 'rl').URL)`)} : typeof require === 'function' ? ${getResolveUrl(`require.toUrl('${amdRelativePath}'), document.baseURI`)} : ${getRelativeUrlFromDocument(relativePath)})`;
    }
};
const importMetaMechanisms = {
    ...
    umd: getGenericImportMetaMechanism(chunkId => `(typeof document === 'undefined' ? ${getResolveUrl(`'file:' + __filename`, `(require('u' + 'rl').URL)`)} : typeof module === 'object' ? ${getResolveUrl(`module.uri, document.baseURI`)} : ${getUrlFromDocument(chunkId)})`)
};
